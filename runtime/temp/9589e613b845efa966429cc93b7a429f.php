<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:78:"D:\WWW\towthinkphp\public/../application/admin/view/default/center\center.html";i:1512054214;s:76:"D:\WWW\towthinkphp\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
		...
		<table>
			...
			<tbody>
				<?php if(!(empty($list) || (($list instanceof \think\Collection || $list instanceof \think\Paginator ) && $list->isEmpty()))): if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
					<tr>
						<td><input class="ids" type="checkbox" name="id[]" value="<?php echo $v['id']; ?>" /></td>
						<td><?php echo $v['name']; ?></td>
						<td><?php echo $v['num']; ?></td>
						<td><?php echo $v['relation']; ?></td>
						<td><?php echo $v['tel']; ?></td>
						<td><?php echo $v['id_number']; ?></td>
						<td><?php echo time_format($v['create_time']); ?></td>
						<td><?php echo !empty($v['status']) && $v['status']==1?"未通过":"通过"; ?></td>
						<td>
							<a class="confirm ajax-get" title="处理" href="<?php echo url('edit?id='.$v['id']); ?>">处理状态</a>
