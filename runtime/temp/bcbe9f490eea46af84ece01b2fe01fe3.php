<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:75:"D:\WWW\towthinkphp\public/../application/admin/view/default/zushou\add.html";i:1512054988;s:76:"D:\WWW\towthinkphp\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<form action="<?php echo url(); ?>" method="post" class="form-horizontal">
    ...
    <div class="form-item">
        ...
        <div class="controls">
            <select name="type">
                <option value="1" <?php if($info['value'] == '1'): ?>selected<?php endif; ?>>出租</option>
                <option value="0" <?php if($info['value'] == '0'): ?>selected<?php endif; ?>>出售</option>
            </select>
        </div>
    </div>
    ...
    <div class="controls">
        ...
        <div class="upload-img-box">
            <?php if(!(empty($info['logo']) || (($info['logo'] instanceof \think\Collection || $info['logo'] instanceof \think\Paginator ) && $info['logo']->isEmpty()))): ?>
            <div class="upload-pre-item"><img src="<?php echo get_cover($info['logo'],'path'); ?>"/></div>
            <?php endif; ?>
        </div>
    </div>
