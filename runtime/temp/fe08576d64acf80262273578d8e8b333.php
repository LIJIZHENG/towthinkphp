<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:75:"D:\WWW\towthinkphp\public/../application/user/view/default/login\index.html";i:1511768305;}*/ ?>
<!DOCTYPE HTML>
    ...
    <form class="login-form" action="" method="post">
      ...
      <div class="control-group">
        <div class="controls">
          ...
          <a href="http://www.mager.com/public/user/user/register.html">新用户注册</a>
        </div>
      </div>
    </form>
  </div>
