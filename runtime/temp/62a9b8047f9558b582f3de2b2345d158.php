<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:78:"D:\WWW\towthinkphp\public/../application/admin/view/default/zushou\zushou.html";i:1512054988;s:76:"D:\WWW\towthinkphp\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<div class="data-table table-striped">
    <table>
        ...
        <tr>
            ...
            <td><?php echo !empty($sale['type'])?"出租":"出售"; ?></td>
            <td><a href="<?php echo url('index?pid='.$channel['id']); ?>"><?php echo $sale['title']; ?></a></td>
            ...
            <td>
                ...
                <a href="<?php echo url('setStatus?ids='.$sale['id'].'&status='.abs(1-$sale['status'])); ?>" class="ajax-get"><?php echo show_status_op($sale['status']); ?></a>
