<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:75:"D:\WWW\towthinkphp\public/../application/admin/view/default/notice\add.html";i:1511857809;s:76:"D:\WWW\towthinkphp\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<div class="main-title cf">
    <h2>
       <?php echo !empty($notice['id'])?'编辑':'新增'; ?>小区通知
    </h2>
</div>
<!-- 标签页导航 -->
<div class="tab-wrap">
    <div class="tab-content">
        ...
        <form id="form" action="<?php echo url('update'); ?>" method="post" class="form-horizontal">
                    ...
                    <label class="textarea">
                        <textarea name="content"><?php echo $data[$field['name']]; ?></textarea>
