<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:76:"D:\WWW\towthinkphp\public/../application/admin/view/default/repairs\add.html";i:1511778547;s:76:"D:\WWW\towthinkphp\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<div class="main-title">
    <h2>
        <?php echo !empty($info['id'])?$info['id']:'新增'; ?>报修
    </h2>
</div>
<form action="<?php echo url(); ?>" method="post" class="form-horizontal">
    ...
    <div class="form-item">
        <label class="item-label">标题(简述报修问题)<span class="check-tips"></span></label>
        <div class="controls">
    ...
    <div class="form-item">
        ...
        <div class="controls">
            <input type="text" class="text input-large" name="content" value="<?php echo (isset($info['url']) && ($info['url'] !== '')?$info['url']:''); ?>">
        </div>
    </div>
    <div class="form-item">
        <label class="item-label">状态是否显示:<span class="check-tips"></span></label>
        <div class="controls">
            <input type="radio" class="text input-large" name="status" value="1"/>显示
            <input type="radio" class="text input-large" name="status" value="0"/>不显示
        </div>
    </div>
     <div class="form-item">
