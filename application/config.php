...
return  [
	...
	// | 系统数据加密设置
	// +----------------------------------------------------------------------
	'data_auth_key' => '-<GxI0@[^Z8pw?{LjX:$!yU"3lSKA.MQ6~bgriJs', //默认数据加密KEY
	'data_cache_key'=> '-<GxI0@[^Z8pw?{LjX:$!yU"3lSKA.MQ6~bgriJs',
    // +----------------------------------------------------------------------
    // | UCenter客户端配置
    // +----------------------------------------------------------------------
    'uc_app_id'   => 1,   //应用ID
    'uc_api_type' =>'Model',    //可选值 Model / Service
    'uc_auth_key' =>'-<GxI0@[^Z8pw?{LjX:$!yU"3lSKA.MQ6~bgriJs', //加密KEY
